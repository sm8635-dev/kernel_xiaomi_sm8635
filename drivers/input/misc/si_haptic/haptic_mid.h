...
#define hp_err(format, ...) pr_err("[sih_haptic]" format, ##__VA_ARGS__)

#define hp_info(format, ...) pr_info("[sih_haptic]" format, ##__VA_ARGS__)

#define hp_dbg(format, ...) pr_debug("[sih_haptic]" format, ##__VA_ARGS__)
