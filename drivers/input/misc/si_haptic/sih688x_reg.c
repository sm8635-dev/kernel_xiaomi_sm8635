...
static bool sih688x_writeable_register(struct device *dev, unsigned int reg)
{
	return true;
}

static bool sih688x_readable_register(struct device *dev, unsigned int reg)
{
	return true;
}

static bool sih688x_volatile_register(struct device *dev, unsigned int reg)
{
	return true;
}
